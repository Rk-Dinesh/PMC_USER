    ...
    <div className="grid grid-cols-12 gap-6 m-8">
      {plans &&
        plans.map((plan, index) => (
          <div class="lg:col-span-3 md:col-span-4 col-span-12 font-poppins font-extralight" key={index}>
            <div class="flex flex-col p-6 text-center text-white bg-[#000928]   shadow outline-none">
              ...
              <ul role="list" class="mb-8 space-y-1 text-left">
                ...
                <li class={`flex items-center space-x-3 ${plan.coursetype === 'Video & Text Course' ? 'opacity-100' : 'opacity-0'}`}>
                  <span>Theory & Video Course </span>
                </li>
              </ul>
              <button class="text-base bg-gradient-to-r from-[#3D03FA] to-[#A71CD2] w-full py-2 ">
                Get started
              </button>
            </div>
          </div>
